            ...
            return (
              ...
              >
                <CardHeader>
                  ...
                  <CardTitle className='text-center text-amber-300 text-lg font-bold'>{feature.title}</CardTitle>
                </CardHeader>
                <CardContent className='text-white font-medium'>{feature.description}</CardContent>
              </Card>
            );
          })}
        </div>
